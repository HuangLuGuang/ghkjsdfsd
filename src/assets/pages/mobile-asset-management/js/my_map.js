...
let mapjs = {
  ...
  device_info(user_deviceInfo) {
    ...
    if (user_deviceInfo != undefined) {
      var pt = user_deviceInfo.lng_lat;
      var car_path;
      ...
      reverse_analysis_address(pt).then((result) => {
        ...
        var device_conent =
          ...
          user_deviceInfo.info +
          "</li>" +
          '<li class="device_info_li">设备序号：' +
          user_deviceInfo.deviceno +
          " </li>" +
          '<li class="device_info_li">定位类型： 卫星定位</li>' +
          '<li class="device_info_li">经纬度：' +
          user_deviceInfo.lng_lat[0] +
          ", " +
          user_deviceInfo.lng_lat[1] +
          "</li>" +
          '<li class="device_info_li">更新时间： ' +
          user_deviceInfo.updatatime +
          "</li>" +
          '<li class="device_info_li">定位时间： ' +
          user_deviceInfo.positiontiome +
          " </li>" +
        ...
        map.setCenter(
          // @ts-ignore
          new BMap.Point(user_deviceInfo.lng_lat[0], user_deviceInfo.lng_lat[1])
        );
