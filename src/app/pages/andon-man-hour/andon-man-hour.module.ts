...
import { MySelectTreeInputComponent } from './components/my-select-tree-input/my-select-tree-input.component';

@NgModule({
  declarations: [
    AndonManHourComponent,
    DeviceAndonStatusInputComponent,
    DeviceAndonStatusInfoComponent,
    MySelectTreeComponent,
    AntTimeLineComponent,
    AgTableComponent,
    DetailComponent,
    DeviceAndonHistoryComponent,
    ErrmsgComponent,
    StatusComponent,
    MySelectTreeInputComponent,
  ],
  imports: [
    CommonModule,
