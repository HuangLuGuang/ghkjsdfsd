...
export class EquipmentCouplingPathComponent implements OnInit {
  ...
  get_device_status() {
    let res;
    this.subscribeList.stauts = this.http
  ...
  get_device_mst_oilseparator() {
    ...
    this.subscribeList.oil = this.http
      .callRPC(
        ...
        {
          device: this.deviceid,
          arr: "hsm1lfon,hsm1lfhigh,hsm2rfon,hsm2rfhigh,hsm3lron,hsm3lrhigh,hsm4rron,hsm4rrhigh",
        }
      )
      .subscribe((f: any) => {
        if (f.result.error || f.result.message[0].code == 0) return;
        ...
        // console.log(f)
        this.real_list[0].value =
          !data.hsm1lfon || data.hsm1lfon == 0
            ? "关"
            : data.hsm1lfhigh == 1
            ? "高"
            : "低";
        this.real_list[0].color =
          !data.hsm1lfon || data.hsm1lfon == 0
            ? "#f595ca"
            : data.hsm1lfhigh == 1
            ? "yellow"
        ...
        this.real_list[1].value =
          !data.hsm2rfon || data.hsm2rfon == 0
            ? "关"
            : data.hsm2rfhigh == 1
            ? "高"
            : "低";
        this.real_list[1].color =
          !data.hsm2rfon || data.hsm2rfon == 0
            ? "#f595ca"
            : data.hsm2rfhigh == 1
            ? "yellow"
        ...
        this.real_list[2].value =
          !data.hsm3lron || data.hsm3lron == 0
            ? "关"
            : data.hsm3lrhigh == 1
            ? "高"
            : "低";
        this.real_list[2].color =
          !data.hsm3lron || data.hsm3lron == 0
            ? "#f595ca"
            : data.hsm3lrhigh == 1
            ? "yellow"
        ...
        this.real_list[3].value =
          !data.hsm4rron || data.hsm4rron == 0
            ? "关"
            : data.hsm4rrhigh == 1
            ? "高"
            : "低";
        this.real_list[3].color =
          !data.hsm4rron || data.hsm4rron == 0
            ? "#f595ca"
            : data.hsm4rrhigh == 1
            ? "yellow"
