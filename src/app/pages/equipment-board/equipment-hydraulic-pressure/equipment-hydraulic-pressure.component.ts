...
export class EquipmentHydraulicPressureComponent implements OnInit {
  ...
  attrs_1: any = {
    "equipment.hydraulic.Passageway4": [
      {
        name: "4号缸位移",
        nameEn: "act410505481BDisplacement",
        unit: "mm",
        value: [],
        show: true,
        color: ["", ""],
    ...
    "equipment.hydraulic.Passageway5": [
      {
        name: "5号缸位移",
        nameEn: "act510506594ADisplacement",
        unit: "mm",
        value: [],
        show: true,
        color: ["", ""],
    ...
    "equipment.hydraulic.Passageway6": [
      {
        name: "6号缸位移",
        nameEn: "Act610506594BDisplacement",
        unit: "mm",
        value: [],
        show: true,
        color: ["", ""],
  ...
  attrs_2: any = {
    "equipment.hydraulic.Passageway1": [
      {
        name: "1缸位移",
        nameEn: "Act110506588ADisplacement",
        unit: "mm",
        value: [],
        show: true,
        color: ["", ""],
    ...
    "equipment.hydraulic.Passageway2": [
      {
        name: "2缸位移",
        nameEn: "Act210506588BDisplacement",
        unit: "mm",
        value: [],
        show: true,
        color: ["", ""],
    ...
    "equipment.hydraulic.Passageway3": [
      {
        name: "3缸位移",
        nameEn: "act310505481ADisplacement",
        unit: "segments",
        value: [],
        show: true,
        color: ["", ""],
  ...
  get_device_mst_oilseparator() {
    this.subscribeList.oil = this.http
      .callRPC(
        "get_device_mts_realtimedata",
        library + "get_device_mts_realtimedata",
        {
          device: this.deviceid,
          arr: "hsmt9j28aon,hsmt9j28ahigh,hsmt9j28bon,hsmt9j28bhigh,hsmt8j28aon,hsmt8j28ahigh,hsmt8j28bon,hsmt8j28bhigh,hsmt7j28aon,hsmt7j28ahigh,hsmt7j28bon,hsmt7j28bhigh",
        }
      )
      .subscribe((f: any) => {
        // console.log(f);
        ...
        if (
          f.result.error ||
          f.result.message[0].code == 0 ||
          !f.result.message[0].message ||
          f.result.message[0].message[0].error
        )
          return;
