...
export class EquipmentShockComponent implements OnInit {
  ...
  get_equip_real() {
    ...
    let res;
    this.subscribeList.equip = this.http
      .callRPC("get_mts_lock", library + "get_mts_lock", {
      ...
      .subscribe((f: any) => {
        ...
        this.real_list[0].value =
          res.maston == 1 ? (res.masthigh == 1 ? "高" : "低") : "关";
        this.real_list[0].color =
          res.maston == 0 ? "#f595ca" : res.masthigh == 0 ? "white" : "yellow";

        //TIF 1
        this.real_list[1].value =
          res.tif1on == 1 ? (res.tif1high == 1 ? "高" : "低") : "关";
        this.real_list[1].color =
          res.tif1on == 0 ? "#f595ca" : res.tif1high == 0 ? "white" : "yellow";

        // TIF 2
        this.real_list[2].value =
          res.tif2on == 1 ? (res.tif2high == 1 ? "高" : "低") : "关";
        this.real_list[2].color =
          res.tif2on == 0 ? "#f595ca" : res.tif2high == 0 ? "white" : "yellow";
      });
  }
