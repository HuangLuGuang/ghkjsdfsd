...
export class TwoDriveChassisComponent implements OnInit {
  ...
  discharge = [
    ...
    {value:'12',name:'mileage4',nameEn:'',unit:'Km'},
    {value:'12',name:'FanSpeedCoefficient_n0',unit:'%'},
    {value:'12',name:'FanSpeedCoefficient_n1',unit:'%/km/h'},
    {value:'12',name:'FanSpeedCoefficient_n2',unit:'%/(km/h)^2'},
  ]
  ...
  resize=()=>{
    ...
    let obs = new Observable(f=>{
      ...
      let id = [
        ...
        'real_temperature_4','real_temperature_5','discharge_chart','discharge_chart_1',
        'gauge_1','gauge_2','gauge_3','gauge_4','avl_param_chart_1','avl_param_chart_2'
      ];
      id.forEach(f=>{
