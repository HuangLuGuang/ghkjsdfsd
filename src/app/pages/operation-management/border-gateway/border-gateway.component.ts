...
export class BorderGatewayComponent implements OnInit {
  ...
  tableDatas = {
    ...
    columnDefs: [
      ...
      {
        field: "edgeGatewayStatus",
        headerName: "边缘网关开关状态",
        resizable: true,
        sortable: true,
      },
      {
        field: "dateGatherStatus",
        headerName: "数据采集状态",
        resizable: true,
        sortable: true,
      },
  ...
  message = [
    {
      id: "1",
      deviceName: "AVL电机测试台架",
      edgeGatewayId: "110001768",
      departmentInfo: "新能源电机试验室",
      edgeGatewayStatus: "开机",
      dateGatherStatus: "运行",
      ipAddress: "192.168.8.108",
      continueTime: "44",
      heartTime: "2020-08-17",
    },
    {
      id: "2",
      deviceName: "AVL电机测试台架",
