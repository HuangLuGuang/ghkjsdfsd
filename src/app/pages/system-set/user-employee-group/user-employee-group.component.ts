...
export class UserEmployeeGroupComponent implements OnInit {
  ...
  tableDatas = {
    ...
    columnDefs:[ // 列字段 多选：headerCheckboxSelection checkboxSelection , flex: 1 自动填充宽度
      { field: 'group', headerName: '科室/功能组', headerCheckboxSelection: true, checkboxSelection: true, autoHeight: true, fullWidth: true, width: 360,resizable: true, cellRendererFramework:TableGroupComponent, sortable: true},
      { field: 'group_name', headerName: '科室/功能组(en)',  resizable: true, width: 250, sortable: true},
      ...
      { field: 'createdby', headerName: '创建人', resizable: true, width: 100, sortable: true},
      { field: 'lastupdateon', headerName: '更新时间', resizable: true, width: 180, sortable: true},
      { field: 'lastupdatedby', headerName: '更新人', resizable: true, flex: 1, sortable: true},
    ],
    rowData: [ // data
    ]
  };
