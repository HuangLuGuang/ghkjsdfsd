...
export class DriveReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    // 得到pathname --在得到button 行驶报表和报警报表的权限一样！
    ...
    // })
    this.button = localStorage.getItem("buttons_list")?JSON.parse(localStorage.getItem("buttons_list")):{};
    console.log("button-------------->drive-report: ", this.button)
  }
