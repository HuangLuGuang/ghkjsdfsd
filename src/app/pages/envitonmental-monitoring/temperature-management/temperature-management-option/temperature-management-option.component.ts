...
declare let $;
@Component({
  selector: "ngx-temperature-management-option",
  templateUrl: "./temperature-management-option.component.html",
  styleUrls: ["./temperature-management-option.component.scss"],
})
export class TemperatureManagementOptionComponent
