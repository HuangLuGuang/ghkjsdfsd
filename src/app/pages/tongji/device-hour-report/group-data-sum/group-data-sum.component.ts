...
export class GroupDataSumComponent implements OnInit {
  ...
  tableDatas = {
    ...
    { field: 'performancerate', headerName: '性能类设备开动率(%)', resizable: true, fullWidth: true,width: 170, sortable: true},
    { field: 'performanceratio', headerName: '性能类设备利用率(%)', resizable: true, fullWidth: true,width: 170, sortable: true},
    { field: 'durablerate', headerName: '耐久类设备开动率(%)', resizable: true, fullWidth: true,width: 170, sortable: true},
    { field: 'durableratio', headerName: '耐久类设备利用率(%)', resizable: true, fullWidth: true,width: 170, sortable: true},
