...
export class MyDateRangeComponent implements OnInit {
  ...
  delet_default(){
    $(".divice_kpi_report_date").remove();
    $(".divice_kpi_report_date_div").html('<input style="height: 31px;" type="text" name="date-range" class="layui-input divice_kpi_report_date" id="divice_kpi_report_date" placeholder=" - ">');
    var that = this;
    layui.use('laydate', function(){
      var laydate = layui.laydate;
      //日期范围 2010-10-01 2020-11-21
