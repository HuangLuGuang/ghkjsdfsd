...
@NgModule({
  declarations: [LiftMachineComponent, StatusMonitorComponent, DeviceKpiTongjiComponent, TotalTimeComponent, StatusComponent, DetailComponent, AgTableComponent, MySelectTreeComponent, MySelectTreeTypeComponent, MyDateRangeComponent, MyInputComponent],
  imports: [
    CommonModule,
