...
import { LayoutsTModule } from "./layouts/layoutsT.module";
import { DeviceKpiTongjiOptionComponent } from './device-kpi-tongji/device-kpi-tongji-option/device-kpi-tongji-option.component';

@NgModule({
  declarations: [
    LiftMachineComponent,
    StatusMonitorComponent,
    DeviceKpiTongjiComponent,
    TotalTimeComponent,
    StatusComponent,
    DetailComponent,
    AgTableComponent,
    ...
    MyInputComponent,
    DeviceKpiTongjiOptionComponent,
    // OneLayoutComponent,
  ],
  imports: [
    CommonModule,
