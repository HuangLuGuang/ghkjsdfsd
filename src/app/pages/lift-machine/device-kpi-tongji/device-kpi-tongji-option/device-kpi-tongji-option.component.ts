...
declare let $;
@Component({
  selector: "ngx-device-kpi-tongji-option",
  templateUrl: "./device-kpi-tongji-option.component.html",
  styleUrls: ["./device-kpi-tongji-option.component.scss"],
})
export class DeviceKpiTongjiOptionComponent
