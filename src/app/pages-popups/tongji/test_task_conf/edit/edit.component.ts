...
export class EditComponent implements OnInit {
  ...
  constructor(
    private dialogRef: NbDialogRef<EditComponent>,
  ...
  ngOnInit(): void {
    ...
    if (taskstatus === "未启动") {
      ...
      $(testrun).attr(
        "class",
        "testrun layui-btn layui-btn-normal layui-btn-radius"
      );
      ...
      switch (taskstatus) {
        case "暂停中": // 暂停中对应试验继续
          ...
          $(testcontinue).attr(
            "class",
            "testcontinue" + " layui-btn layui-btn-normal layui-btn-radius"
          );
          $(cancel).attr(
            "class",
            "cancel" + " layui-btn layui-btn-primary layui-btn-radius"
          );
          $(teststop).addClass("layui-btn-disabled");
        ...
        case "进行中": //进行中对应试验完成
          ...
          $(teststop).attr(
            "class",
            "teststop" + " layui-btn layui-btn-normal layui-btn-radius"
          );
          $(testcontinue).addClass("layui-btn-disabled");
          $(testrun).addClass("layui-btn-disabled");
          break;
        case "已完成": //已完成对应试验完成
          ...
          $(testcomplete).attr(
            "class",
            "testcomplete" + " layui-btn layui-btn-normal layui-btn-radius"
          );
          $(testrun).addClass("layui-btn-disabled");
          $(teststop).addClass("layui-btn-disabled");
          $(testcontinue).addClass("layui-btn-disabled");
        ...
        case "已取消": //已完成对应试验完成
          ...
          $(cancel).attr(
            "class",
            "cancel" + " layui-btn layui-btn-normal layui-btn-radius"
          );
          $(testrun).addClass("layui-btn-disabled");
          $(teststop).addClass("layui-btn-disabled");
          $(testcontinue).addClass("layui-btn-disabled");
    ...
    layui.use(["form", "laydate"], function () {
      ...
      form.verify({
        ...
        devicetasknownumbers: function name(value, item) {
          // 试验总轮次
          var devicetasknumbers = Number(
            $("input[name='devicetasknumbers']").val()
          );
          // 试验当前轮次
  ...
  teststatus(value) {
    ...
    if (this.taskstatus_value === "试验完成") {
      if (mytitle === "试验暂停") {
        ...
        $(".testcomplete").attr(
          "class",
          "testcomplete" + " layui-btn layui-btn-primary layui-btn-radius"
        );
        $(".cancel").attr(
          "class",
          "cancel" + " layui-btn layui-btn-primary layui-btn-radius"
        ...
        $(".teststop").attr(
          "class",
          "teststop" + " layui-btn layui-btn-primary layui-btn-radius"
        );
        $(".testcomplete").attr(
          "class",
          "testcomplete" + " layui-btn layui-btn-normal layui-btn-radius"
      ...
      if (mytitle === "试验继续") {
        ...
        $(".testcontinue").attr(
          "class",
          "testcontinue" + " layui-btn layui-btn-primary layui-btn-radius"
        );
        this.taskstatus_value_tosave = mytitle;
      }
    } else if (this.taskstatus_value === "试验暂停") {
      // 可取消
      if (mytitle === "试验继续") {
        $(".testcontinue").attr(
          "class",
      ...
      if (mytitle === "试验启动") {
        ...
        $(".testrun").attr(
          "class",
          "testrun" + " layui-btn layui-btn-primary layui-btn-radius"
        );
        $(".cancel").attr(
          "class",
          "cancel" + " layui-btn layui-btn-normal layui-btn-radius"
