...
let Mandarin = require("../../../../assets/pages/tongji/flatpickr/zh.js")
  .default.zh;
...
export class TargetHourConfigComponent implements OnInit {
  ...
  constructor(
    private dialogRef: NbDialogRef<TargetHourConfigComponent>,
  ...
  get_date_return_date() {
    ...
    var before_min = new Date(
      before_date.getFullYear(),
      before_date.getMonth(),
      1
    );
    var before_max = new Date(
      before_date.getFullYear(),
      before_date.getMonth() + 1,
      0
    );
